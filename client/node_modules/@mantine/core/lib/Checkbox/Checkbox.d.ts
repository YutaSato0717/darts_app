...
export interface CheckboxProps extends DefaultProps<CheckboxStylesNames, CheckboxStylesParams>, Omit<React.ComponentPropsWithoutRef<'input'>, 'type' | 'size'> {
    /** Key of theme.colors */
    color?: MantineColor;
...
declare type CheckboxComponent = ForwardRefWithStaticComponents<HTMLInputElement, CheckboxProps, {
