...
export interface ChipProps extends DefaultProps<ChipStylesNames, ChipStylesParams>, Omit<React.ComponentPropsWithoutRef<'input'>, 'size' | 'onChange'> {
...
declare type ChipComponent = ForwardRefWithStaticComponents<HTMLInputElement, ChipProps, {
