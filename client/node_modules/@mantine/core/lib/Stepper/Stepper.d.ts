...
export interface StepperProps extends DefaultProps<StepperStylesNames>, React.ComponentPropsWithoutRef<'div'> {
...
declare type StepperComponent = ForwardRefWithStaticComponents<HTMLDivElement, StepperProps, {
    Step: typeof Step;
